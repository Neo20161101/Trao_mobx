...
class Index extends Component {
  ...
  componentDidMount() {
    // const { stateStore } = this.props.store
    // stateStore.getSetting()
    console.log(12433546546)
  }
  ...
  render() {
    ...
    return (
      <View className='home'>
        ...
        <AtTabs className="AtTabs" current={current} tabList={[{title: '我的关注'}, {title: '我的邀请'}]}
                onClick={this.handleAtTabsClick}>
          <AtTabsPane current={current} index={0}>
            <View style=''>
              <View className="cen">
                <Swiper className='u-wrp-bnr top1 swiper-box' indicator-dots='true' autoplay='true' interval='5000'
                        duration='1000' circular='true' indicator-active-color='rgb(246,246,246)'>
                  {
