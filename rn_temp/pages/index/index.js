...
var Index = (_dec = (0, _mobxRn.inject)('counterStore'), _dec(_class = (0, _mobxRn.observer)(_class = (_temp2 = _class2 = function (_Component) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.increment = function () {
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      var counter = this.props.counterStore.counter;
